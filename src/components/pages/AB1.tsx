...
const allEvents: Event[] = [
  /* ── 13 March Events ── */
  {
    ...
    description: "The ultimate showdown for tech enthusiasts. Teams battle through rapid-fire rounds of science and technology trivia — only the sharpest minds survive.",
    image: "",
  ...
  },
  {
    ...
    description: "The cult game comes alive! Find the impostor, defend your crewmate status, and navigate deception in this immersive real-life version of Among Us.",
    image: "",
  ...
  },
  {
    ...
    description: "Her Campus returns with the third edition of its beloved improv and affirmation fest. A safe, joyful space celebrating confidence, creativity, and community.",
    image: "",
  ...
  },
  {
    ...
    description: "IEEE CIS challenges participants to build and present AI models. From classification to generation, showcase your ML skills in this competitive quest.",
    image: "",
  ...
  },
  {
    ...
    description: "A full-floor cybersecurity experience — CTF challenges, ethical hacking demos, and digital forensics puzzles across multiple rooms of AB1's third floor.",
    image: "",
    startTime: "2026-03-13T12:30:00", endTime: "2026-03-13T17:00:00",
  },
  {
    ...
    description: "IEEE WIE hosts a competitive event empowering women in engineering. Rise, compete, and conquer in this challenge built to celebrate brilliance.",
    image: "",
  ...
  },
  {
    ...
    description: "A mock hiring competition where participants pitch themselves, survive rapid interview rounds, and outshine rivals to land the fictional dream job.",
    image: "",
  ...
  },
  {
    ...
    description: "SIGBED presents the third edition of Nextrack — an embedded systems and IoT showcase in the AB1 lobby. Witness cutting-edge projects from MUJ's best builders.",
    image: "",
    startTime: "2026-03-13T12:30:00", endTime: "2026-03-13T17:00:00",
  },
  {
    ...
    description: "Step into a world built from imagination. De Artistry Club's immersive installation invites you to explore a surreal dreamscape of your own creation.",
    image: "",
    startTime: "2026-03-13T12:30:00", endTime: "2026-03-13T16:00:00",
  },
  {
    ...
    date: "13 March, 2026", time: "12:30 pm - 4 pm", venue: "AB1 Cheffie",
    description: "Something happened at 2:17 AM — but what? De Artistry Club's mystery art experience unfolds clue by clue through an eerie and thought-provoking installation.",
    image: "",
    startTime: "2026-03-13T12:30:00", endTime: "2026-03-13T16:00:00",
  },
  {
    ...
    description: "Convergence celebrates the planet through art. Edition 3.0 brings eco-conscious creative exhibits to the Cheffie Lawn — where sustainability meets expression.",
    image: "",
    startTime: "2026-03-13T12:30:00", endTime: "2026-03-13T17:00:00",
  },
  {
    ...
    description: "One person, one stage, one story. Cinephilia's monologue competition is a test of raw performance skill — where every word and silence carries weight.",
    image: "",
    startTime: "2026-03-13T15:00:00", endTime: "2026-03-13T17:00:00",
  },
  ...
  /* ── 14 March Events ── */
  {
    ...
    description: "A prompt engineering challenge where participants craft the most effective AI inputs to solve real-world tasks. Precision and creativity determine the winner.",
    image: "",
  ...
  },
  {
    ...
    description: "Which fanbase has the most dedicated devotees? Marksoc brings pop culture communities head-to-head in a trivia and passion-fuelled face-off.",
    image: "",
  ...
  },
  {
    ...
    description: "Coreographia's full-day dance intensive. Ground 0 is where raw talent meets training — workshops, battles, and performances across an entire day of movement.",
    image: "",
  ...
  },
  {
    ...
    description: "ACM Chapter's flagship escape-room-meets-tech-challenge. Crack the Chrono Protocol, solve time-sensitive puzzles, and save the mission from collapse.",
    image: "",
    startTime: "2026-03-14T09:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "Day 2 of the real-life Among Us experience. New impostors, new maps, and even trickier betrayals await. Can you trust anyone this time around?",
    image: "",
  ...
  },
  {
    ...
    description: "NEXUS MUJ launches you into a space-themed coding crisis. Solve programming challenges against the clock to prevent catastrophic orbital failure.",
    image: "",
  ...
  },
  {
    ...
    description: "Her Campus continues the conversation on Day 2. More affirmations, more improv, and more moments that remind you to just say yes to yourself.",
    image: "",
  ...
  },
  {
    ...
    description: "Managia's social deduction spectacle. Allies scheme, betrayers lurk, and every room is a trap. Navigate the maze of trust and survive the day as a non-traitor.",
    image: "",
  ...
  },
  {
    ...
    description: "COSMOS brings its 9th edition of Quigencia — a mind-bending quiz meets cosmic auction. Bid on clues, strategise your purchases, and outsmart the galaxy.",
    image: "",
  ...
  },
  {
    ...
    description: "Day 2 of Cyber Sphere 360 goes deeper — advanced challenges, live vulnerability demos, and full-scale war-games across AB1's upper floor.",
    image: "",
    startTime: "2026-03-14T09:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "IEEE Student Branch hosts CHECKMATE — a multi-round technical quiz and problem-solving marathon. Every wrong move costs you; every right one advances you.",
    image: "",
    startTime: "2026-03-14T09:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "EIS puts you in the hot seat of corporate decision-making. Manage crises, pitch strategies, and lead your virtual company to success — for exactly one day.",
    image: "",
    startTime: "2026-03-14T12:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "Rotaract transforms the AB1 lobby into a carnival of games, stalls, and fun. Take a break from the intensity and enjoy the lighter side of Oneiros.",
    image: "",
    startTime: "2026-03-14T09:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "Coreographia takes over the AB1 lobby for a live showcase of Ground Zero performances. Watch breathtaking dance routines spill into the hallways.",
    image: "",
  ...
  },
  {
    ...
    description: "Day 2 of De Artistry Club's dreamscape installation. More visitors, more interpretations, and more surreal moments to discover and share.",
    image: "",
    startTime: "2026-03-14T11:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    title: "The 2:17 AM Incident / De Artistry club",
    date: "14 March, 2026", time: "11 am - 5 pm", venue: "AB1 Cheffie",
    description: "The mystery deepens on Day 2. More clues have surfaced at the Cheffie — piece together what really happened at 2:17 AM before time runs out.",
    image: "",
    startTime: "2026-03-14T11:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    ...
    description: "Day 2 of Artful Earth 3.0 continues Convergence's eco-art mission. New installations, live art, and sustainability discussions on the sun-drenched Cheffie Lawn.",
    image: "",
    startTime: "2026-03-14T09:00:00", endTime: "2026-03-14T17:00:00",
  },
  {
    title: "CHECKMATE / IEEE SB",
    date: "14 March, 2026", time: "9 pm - 5 pm", venue: "AB1 Cheffie Lawn Left Side",
    description: "An after-dark extension of CHECKMATE spreads to the Cheffie Lawn. Night-time problem-solving with a twist — the atmosphere changes, but the stakes stay high.",
    image: "",
  ...
  /* ── 15 March Events ── */
  {
    ...
    description: "The final day of Cyber Sphere 360 brings the closing challenges and awards. A grand cybersecurity finale to cap off three days of digital warfare.",
    image: "",
